...
public class RepositorioPedidos {
    ...
    public final List<Pedido> fallidos = Collections.synchronizedList(new ArrayList<>());
    public final List<Pedido> verificados = Collections.synchronizedList(new ArrayList<>());
}
